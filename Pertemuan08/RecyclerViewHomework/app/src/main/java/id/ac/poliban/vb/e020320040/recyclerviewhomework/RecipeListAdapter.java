package id.ac.poliban.vb.e020320040.recyclerviewhomework;
...
public class RecipeListAdapter extends RecyclerView.Adapter<RecipeListAdapter.RecipeViewHolder> {
    ...
    public final static String EXTRA_NAME = "id.ac.poliban.vb.e020320040.recyclerviewhomework.EXTRA.NAME";
