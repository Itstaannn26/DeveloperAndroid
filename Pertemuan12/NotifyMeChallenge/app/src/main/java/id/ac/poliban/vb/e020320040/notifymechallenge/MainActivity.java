package id.ac.poliban.vb.e020320040.notifymechallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.vb.e020320040.notifymechallenge.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Intan - NotifyMeChallenge");
