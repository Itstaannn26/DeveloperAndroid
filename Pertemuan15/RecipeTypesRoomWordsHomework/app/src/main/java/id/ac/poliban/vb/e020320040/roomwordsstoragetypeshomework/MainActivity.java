package id.ac.poliban.vb.e020320040.roomwordsstoragetypeshomework;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.vb.e020320040.roomwordsstoragetypeshomework";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Intan - RoomWordsStorageTypesHomework");
