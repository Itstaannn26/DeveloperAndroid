package id.ac.poliban.vb.e020320040.listshoppingmapschallenge;
...
public class MainActivity2 extends AppCompatActivity {
    public static final String EXTRA_ITEMS = "id.ac.poliban.vb.e020320040.listshoppingmapschallenge.extra.ITEMS";
    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()){
            ...
            default:
                Toast.makeText(MainActivity2.this, "There was an error", Toast.LENGTH_LONG).show();
                break;
        }
